...
def write_version(version_core, pre_release=True):
    ...
    with open(Path("tzq_cvae", "version.py"), "w") as f:
        f.write('__version__ = "{}"\n'.format(version))
...
setup(
    ...
    description="An implementation of conditional variational autoencoder",
    author="enhuiz",
    ...
    url="https://github.com/enhuiz/cvae",
    entry_points={
        "console_scripts": [
            "tzq-cvae-baseline=tzq_cvae.runners.baseline:main",
            "tzq-cvae=tzq_cvae.runners.cvae:main",
        ],
    },
)
